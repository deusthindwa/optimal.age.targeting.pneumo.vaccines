...
dat <- list(`Andrews (2012)` = list(`0-2` = c(48, 32, 60),
                                    `2-5` = c(21, 03, 06),
                                    `5-Inf` = c(15, -3, 30)),
            
            `Wright (2013)` = list(`0-5` = c(-9, -119, 43),
                                   `5-10` = c(38.3, -6, 64),
                                   `10-Inf` = c(-21, -137, 35)),
            
            `Rudnick (2013)` = list(`0-5` = c(41.3, 20, 57),
                                    `5-Inf` = c(34.1, 6, 54)),
            
            `Guttierez (2014)` = list(`0-5` = c(44.5, 19, 62),
                                      `5-Inf` = c(32.5, -6, 57)),
            
            `Djennad (2018)` = list(`0-2` = c(41, 23, 54),
                                    `2-5` = c(34, 16, 48),
                                    `5-Inf` = c(23, 12, 32)))
...
df <- dat_ %>% filter(Study != "Wright (2013)") %>% rename(y = "Mean")
...
VE_plot <- ggplot(data=df) +
  ...
  labs(x = "Years since vaccination (t)", y = "Vaccine efficacy (VE, %)") +
...
ggsave("output/Fig3_vaccine_efficacy.png",
       plot = VE_plot,
       width = 8, height = 2.5, unit="in", dpi = 300)
